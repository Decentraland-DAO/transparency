...
export enum TagType {
  ...
  OPERATIONAL_GRANT = 'Operational Grant',
...
export enum TagCategoryType {
  ...
  FACILITATION_PAYOUT,
  OPERATIONAL_GRANTS_PAYOUT,
  COMMUNITY_GRANTS_PAYOUT,
  BIDS_PAYOUT,
  GRANTS_REVENUE,
...
const TAG_CATEGORIES: Record<keyof typeof TagCategoryType, TagCategory> = {
  ...
  OPERATIONAL_GRANTS_PAYOUT: { name: 'Operational Grants Payout', description: 'Transactions corresponding to the funding of the vesting contracts for approved DAO Operational Grants projects' },
  COMMUNITY_GRANTS_PAYOUT: { name: 'Community Grants Payout', description: 'Transactions corresponding to the funding of the vesting contracts for approved DAO Community Grants projects' },
...
const TAG_CATEGORY_MAPPING: Record<ExportedTagType, TagCategory> = {
  ...
  [TagType.OPERATIONAL_GRANT]: TAG_CATEGORIES.OPERATIONAL_GRANTS_PAYOUT,
  [TagType.COMMUNITY_GRANT]: TAG_CATEGORIES.COMMUNITY_GRANTS_PAYOUT,
